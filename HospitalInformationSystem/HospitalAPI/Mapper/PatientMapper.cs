...
namespace HospitalAPI.Mapper
{
    public class PatientMapper
    {
        ...
        {
            return new Patient(dto.Name, dto.LastName, dto.Jmbg, dto.Username, dto.Password, dto.Email, dto.Phone, false, "", false, dto.DateOfBirth, dto.Allergens, dto.Doctor, dto.IsActivated, dto.Token);
        }
        public static PatientDto PatientToPatientkDto(Patient patient)
        {
            return new PatientDto(patient.Name, patient.LastName, patient.Jmbg, patient.Username, patient.Password, patient.Email, patient.Phone, patient.DateOfBirth,
                patient.Allergens, patient.Doctor, patient.IsActivated, patient.Token);
        }
    }
}
