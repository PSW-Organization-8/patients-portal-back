...
namespace HospitalTests.Integration
{
    public class ReceiptCreationTests
    {
        ...
        private ReceiptController MakeController(MyDbContext dbContext) 
        {
            ...
            IVacationRepository vacationRepository = new VacationRepository(dbContext);
            DoctorService doctorService = new DoctorService(doctorRepository, shiftRepository, vacationRepository);
